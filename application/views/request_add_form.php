    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <?php print form_input('dob', NULL, array('class' => 'form-control', 'required' => 1, 'placeholder' => 'Format: mm-dd-yyyy')); ?>
            </div>
            ...
            <div class="form-group">
                ...
                <?php print form_input('manager_name', NULL, array('class' => 'form-control', 'required' => 1, 'placeholder' => 'e.g. Dr. M. Amin Khan')); ?>
            </div>
        ...
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <?php print form_input('phone', NULL, array('class' => 'form-control', 'required' => 1, 'placeholder' => 'e.g. 02134014743(9876)')); ?>
            </div>

            <div class="form-group">
                <?php print form_label('Phone (Mobile) (Optional)'); ?>
                <?php print form_input('phone_mobile', NULL, array('class' => 'form-control', 'placeholder' => 'e.g. 03002294117')); ?>
            </div>

            <div class="form-group">
                <?php print form_label('Email (optional)'); ?>
                <?php print form_input('mail', NULL, array('class' => 'form-control', 'placeholder' => 'e.g. demo@demo.com')); ?>
            </div>
